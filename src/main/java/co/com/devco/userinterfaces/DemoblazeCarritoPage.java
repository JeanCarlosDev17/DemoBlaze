...
public class DemoblazeCarritoPage {
	...
	public static final Target LINK_DELETE_PRODUCTO_CARRITO = Target.the("Link para borrado de productos del carrito").locatedBy("//tbody[@id='tbodyid']/tr/td[text()='{0}']/..//a[text()='Delete']");
